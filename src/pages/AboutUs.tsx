            ...
            {[
              {
                ...
                address: 'BLOCK A, JOS FOOD COMPLEX, ADJACENT CIVIL DEFENSE HEADQUARTERS, JOS, PLATEAU STATE.',
                phone: '+2349167313334',
                whatsapp: '+2349167313334',
                icon: <Building2 className="w-6 h-6" />
              },
              {
              ...
              },
              {
                ...
                address: '16, OPP. RICE MARKET ROAD',
                phone: '+2347032554599',
                icon: <MapPin className="w-6 h-6" />
              },
              {
              ...
              {
                title: 'Port Harcourt Contact Office',
                address: 'No13 ANDONI STREET BY REX-LAWNSON JUNCTION, BORIKIRI PHC',
                phone: '+2347064329762',
                icon: <MapPin className="w-6 h-6" />
              }
            ].map((office, idx) => (
              ...
              >
                ...
                {office.phone && (
                  <div className="flex items-center space-x-2 text-brand-green font-bold mb-2">
                ...
                {office.whatsapp && (
                  <div className="flex items-center space-x-2 text-green-500 font-bold">
                    ...
                    <span>SBH WHATSAPP: {office.whatsapp}</span>
                  </div>
                )}
              </motion.div>
            ))}
